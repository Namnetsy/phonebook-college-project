...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->pictureBox1->Size = System::Drawing::Size(45, 39);
			...
			this->label1->Location = System::Drawing::Point(56, 4);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(240, 39);
			this->label1->TabIndex = 1;
			this->label1->Text = L"Vasya Pupkin";
			// 
			// pictureBox2
			// 
			this->pictureBox2->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"pictureBox2.Image")));
			this->pictureBox2->Location = System::Drawing::Point(1023, 7);
			...
			this->Size = System::Drawing::Size(1066, 46);
